...
function canonicalizeArtistName(rawArtist, artistAliasMap) {
  const normalizedArtist = toNonEmptyString(rawArtist, "Unknown Artist");
  return artistAliasMap.get(normalizedArtist.toLowerCase()) || normalizedArtist;
}
